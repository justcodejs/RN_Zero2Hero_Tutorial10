# JustCode - React Native Zero to Hero Tutorial 10
Hi! Welcome to JustCode React Native Zero to Hero Tutorial 10 Github page. To run the application in this Github page you need to:
...
`git clone https://github.com/justcodejs/RN_Zero2Hero_Tutorial09.git`
